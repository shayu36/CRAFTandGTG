...
当前完整建模流程见 [docs/THREE_LAYER_MODELING_PIPELINE.md](docs/THREE_LAYER_MODELING_PIPELINE.md)，Word 版见 [docs/THREE_LAYER_MODELING_PIPELINE.docx](docs/THREE_LAYER_MODELING_PIPELINE.docx)。Stage 4 第一次正式实验结果见 [docs/experiments/第一次实验.md](docs/experiments/第一次实验.md)。
